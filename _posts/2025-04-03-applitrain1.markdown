...
開発実践の講習に入るまで日付に余裕があり、かつ、まだ身になっていないと感じているので、<br>
今日はもっと基本的なものに立ち返ったものから作ろうと思い、単純な計算機アプリを作ってみました。<br>
chatGPTの助力があったのに、途中で要らなかった寄り道もした結果数時間もかかった…。
...
明日はこれをWindowsアプリの電卓風にした上で、できれば更に機能を追加してみたい。
